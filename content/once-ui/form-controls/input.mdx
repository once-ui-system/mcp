...
Use the `placeholder` prop to use placeholder instead of label. The placeholder disappears when the input has value. Never use placeholder and label at the same time.
